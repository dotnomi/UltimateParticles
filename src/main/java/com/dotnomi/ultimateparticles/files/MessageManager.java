...
public class MessageManager {
    ...
    public static void load() {
        ...
        try {
            ...
            // GENERAL MESSAGES
            Messages.GENERAL_PREFIX = messageConfig.getString("general.prefix");
            Messages.GENERAL_PROGRESS_BAR = messageConfig.getString("general.progress-bar");

            // INFO MESSAGES
            Messages.INFO_RELOAD = messageConfig.getString("info.reload");
            Messages.INFO_CACHE_GEN_STARTED = messageConfig.getString("info.image-cache-generate-started");
            Messages.INFO_CACHE_GEN_FINISHED = messageConfig.getString("info.image-cache-generate-finished");
            Messages.INFO_CACHE_DELETED = messageConfig.getString("info.image-cache-delete");

            // ERROR MESSAGES
            Messages.ERROR_CACHE_GEN_ALREADY_RUNNING = messageConfig.getString("error.process-is-already-running");
